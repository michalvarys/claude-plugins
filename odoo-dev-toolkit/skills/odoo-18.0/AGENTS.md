...
npx skills add michalvarys/claude-plugins
```
...
- URL: `git@github.com:michalvarys/claude-plugins.git`
- Branch: `master`
- Subfolder: `odoo-dev-toolkit/skills/odoo-18.0/`
...
After installing via `npx skills add michalvarys/claude-plugins`, the skill is placed at:
